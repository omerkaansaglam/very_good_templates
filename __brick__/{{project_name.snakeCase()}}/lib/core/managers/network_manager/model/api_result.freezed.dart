...
class _$SuccessImpl<T> extends Success<T> with DiagnosticableTreeMixin {
  _$SuccessImpl([this.value]) : super._();
...
abstract class Success<T> extends ApiResult<T> {
  factory Success([final T? value]) = _$SuccessImpl<T>;
  Success._() : super._();
...
class _$FailureImpl<T> extends Failure<T> with DiagnosticableTreeMixin {
